...
class ConnectingPage(Pages_Client.Base_Page.BasePage):
    ...
    def StartUpUIElementsPack(self):
        ...
        localNetworkBtn = customtkinter.CTkButton(master=self,
                                                  ...
                                                  width=150,
                                                  height=45,
                                                  image=tkinter.PhotoImage(file=os.getcwd()+"\\Img\\local_network_icon.png"),
        ...
        internetBtn = customtkinter.CTkButton(master=self,
                                              ...
                                              width=125,
                                              height=45,
                                              image=tkinter.PhotoImage(file=os.getcwd()+"\\Img\\internet_icon.png"),
    ...
    def LoadLocalNetworkChoiceUI(self):
        ...
        saveAndConnectBtn = customtkinter.CTkButton(master=self,
                                              ...
                                              width=125,
                                              height=45,
                                              image=tkinter.PhotoImage(file=os.getcwd()+"\\Img\\connection_icon.png"),
    ...
    def CheckEnteredSettings(self):
        # The function gets nothing.
        # The function checks the entered settings and if so the client will be created and the controlled page 
        # going to be loaded.
        ...
        self.destroy()
        self.master.ShowFrame("ControlledPage")
    ...
    def LoadErrorIpTyping(self):
        ...
        customtkinter.CTkLabel(master=self,
                               text="",
                               image=tkinter.PhotoImage(file=os.getcwd()+"\\Img\\error_icon.png"),
