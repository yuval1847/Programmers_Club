...
class Client:
    ...
    def __init__(self, serverAddr: str) -> None:
    ...
    def SendFrame(self, compressedFrame:bytes):
        ...
        self.framesScoket.sendto(str(compressedFrameBytesSize).encode(), self.serverAddr)
        self.framesScoket.sendto(compressedFrame, self.serverAddr)