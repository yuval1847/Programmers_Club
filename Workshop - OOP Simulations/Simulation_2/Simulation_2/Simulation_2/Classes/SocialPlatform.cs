...
namespace Simulation_2.Classes
{
    internal abstract class SocialPlatform
    {
        ...
        public void SendFriendRequest(User sender, User receiver, string meetingMessage)
        {
            FriendRequest friendRequest = new FriendRequest(sender, receiver, meetingMessage);
            sender.OfferFriendRequest(friendRequest);
        }
        ...
        public void SendMessageToChat(Chat chat, Message message)
        {
